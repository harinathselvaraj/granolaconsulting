...
(function () {
    ...
    function renderPlanPanel() {
        ...
        html +=
            '<p class="hg-onboard-panel-lead">Business and Enterprise receive a <strong>dedicated AWS stack</strong> (VPC, ECS Fargate, RDS). Provisioning typically takes <strong>10–20 minutes</strong>. Want to try Starter first? <a href="/sign-in?plan=starter">Start free</a> — 14-day trial, no credit card (shared pool, 1 user).</p>';
