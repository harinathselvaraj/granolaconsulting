...
(function () {
    ...
    function showEnrollResult(data, idToken) {
        ...
        html +=
            '<p class="hg-signin-lead"><a href="https://www.granolaconsulting.com/blog/honeygold-mcp-claude-desktop">How to set up HoneyGold MCP in Claude Desktop</a></p>';
        if (data.mock) {
            html += '<p class="hg-signin-lead"><em>Demo mode:</em> enroll API not called.</p>';
        }
        html +=
            '<p class="hg-signin-foot"><a href="/onboard?product=honeygold&plan=business">Upgrade to Business</a></p>';
