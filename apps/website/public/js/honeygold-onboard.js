...
(function () {
    ...
    function renderPlanPanel() {
        ...
        html +=
            '<p class="hg-onboard-panel-lead">Business and Enterprise receive a <strong>dedicated AWS stack</strong> (VPC, ECS Fargate, RDS). Provisioning typically takes <strong>10–20 minutes</strong>. Want free instant access? <a href="https://app.granolaconsulting.com/sign-in?plan=starter">Start free with Google</a> on Starter (shared pool, 1 user).</p>';
    ...
    function renderContactPanel() {
        ...
        html +=
            ...
            '<a href="https://app.granolaconsulting.com/terms" target="_blank" rel="noopener noreferrer">Terms of Service</a> and ' +
            '<a href="https://app.granolaconsulting.com/privacy-policy" target="_blank" rel="noopener noreferrer">Privacy Policy</a> ' +
    ...
    function submitEnterpriseInquiry() {
        ...
        if (useMockApi()) {
            clearDraft();
            window.location.href = "https://app.granolaconsulting.com/enterprise-thanks";
            return;
        }
    ...
    function onboardBackHref() {
        if (state.mode === "starter") {
            return "https://app.granolaconsulting.com/sign-in?product=honeygold&plan=starter";
        }
    ...
    function starterSigninUrl(tenantId) {
        return (
            "https://app.granolaconsulting.com/sign-in?product=honeygold&plan=starter&tenantId=" +
    ...
    function initStarterOnboarding() {
        ...
        loadStarterSession();
        if (!state.tenantId) {
            window.location.replace("https://app.granolaconsulting.com/sign-in?product=honeygold&plan=starter");
            return;
        }
        saveStarterSession();
